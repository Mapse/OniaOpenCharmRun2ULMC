...
# with command line options: step5 --filein file:JpsiToMuMuwithDstar_13TeV_HLT.root --fileout file:JpsiToMuMuwithDstar_13TeV_RECO.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_upgrade2018_realistic_v15_L1v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --nThreads 1 --geometry DB:Extended --era Run2_2018 --python_filename JpsiToMuMuwithDstar_13TeV_RECO_2018_cfg.py -n 1 --no_exec
