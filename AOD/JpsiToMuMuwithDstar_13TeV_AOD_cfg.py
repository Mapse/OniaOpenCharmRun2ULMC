...
# with command line options: --filein file:JpsiToMuMuwithDstar_13TeV_HLT.root --fileout file:JpsiToMuMuwithDstar_13TeV_AOD.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_mc2017_realistic_v7 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 1 --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithDstar_13TeV_AOD_cfg.py -n -1 --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:JpsiToMuMuwithDstar_13TeV_HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithDstar_13TeV_AOD.root'),
