...
if [[ "$MonteCarlo_energy" == "7TeV" ]]; then
   ...
   # Runs Monte Carlo for production of J/Psi meson associated with D+ meson.
      ...
      echo -e " \n \n -------------------------- Running fragment for D+ meson --------------------------"
      cmsDriver.py Configuration/GenProduction/python/JpsiToMuMuwithDPlus_13TeV.py --fileout file:JpsiToMuMuwithDPlus_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithDPlus_13TeV_GS.py --no_exec -n $MonteCarlo_numevts
   ...
   # Runs Monte Carlo for production of J/Psi meson associated with D_s+ meson.
      ...
      echo -e " \n \n -------------------------- Running fragment for D_s+ meson --------------------------"
      cmsDriver.py Configuration/GenProduction/python/JpsiToMuMuwithDSPlus_13TeV.py --fileout file:JpsiToMuMuwithDSPlus_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithDSPlus_13TeV_GS.py --no_exec -n $MonteCarlo_numevts
