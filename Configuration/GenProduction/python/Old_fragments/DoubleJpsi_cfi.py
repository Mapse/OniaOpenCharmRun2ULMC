...
# cmsDriver.py Configuration/GenProduction/python/DoubleJpsi_cfi.py --fileout file:DoubleJpsi_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename DoubleJpsi_GS.py --no_exec -n $MonteCarlo_numevts
