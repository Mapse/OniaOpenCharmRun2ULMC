...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithDSPlus_13TeV_cfi.py --fileout file:JpsiToMuMuwithDSPlus_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithDSPlus_13TeV_GS.py --no_exec -n 50000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JpsiToMuMuwithDSPlus_13TeV_cfi.py nevts:50000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithDSPlus_13TeV_GS.root'),
