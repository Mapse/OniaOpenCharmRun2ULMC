...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithDstar_13TeV_cfi.py --fileout file:JpsiToMuMuwithDstar_13TeV_2018_GS.root --mc --eventcontent RAWSIM --runUnscheduled --datatier GEN-SIM --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --customise Configuration/DataProcessing/Utils.addMonitoring --era Run2_2018 --python_filename JpsiToMuMuwithDstar_13TeV_2018_GS_cfg.py -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JpsiToMuMuwithDstar_13TeV_cfi.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithDstar_13TeV_2018_GS.root'),
...
process.dstarfilter = cms.EDFilter("MCSingleParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.jpsifilter+process.dstarfilter+process.mumufilter)
