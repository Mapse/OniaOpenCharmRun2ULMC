...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithLambdaCPlus_13TeV_cfi.py --fileout file:JpsiToMuMuwithLambdaCPlus_13TeV_2018_GS.root --mc --eventcontent RAWSIM --runUnscheduled --datatier GEN-SIM --conditions 106X_upgrade2018_realistic_v11_L1v1 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --customise Configuration/DataProcessing/Utils.addMonitoring --era Run2_2018 --python_filename JpsiToMuMuwithLambdaCPlus_13TeV_2018_GS_cfg.py -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JpsiToMuMuwithLambdaCPlus_13TeV_cfi.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithLambdaCPlus_13TeV_2018_GS.root'),
