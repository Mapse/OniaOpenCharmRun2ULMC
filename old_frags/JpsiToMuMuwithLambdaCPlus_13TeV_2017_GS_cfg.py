...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithLambdaCPlus_13TeV_cfi.py --fileout file:JpsiToMuMuwithLambdaCPlus_13TeV_2017_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithLambdaCPlus_13TeV_2017_GS_cfg.py -n 10000 --no_exec
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithLambdaCPlus_13TeV_2017_GS.root'),
