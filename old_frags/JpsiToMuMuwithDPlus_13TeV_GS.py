...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithDPlus_13TeV_cfi.py --fileout file:JpsiToMuMuwithDPlus_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename JpsiToMuMuwithDPlus_13TeV_GS.py --no_exec -n 10000
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithDPlus_13TeV_GS.root'),
