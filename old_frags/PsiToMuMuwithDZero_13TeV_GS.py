...
# with command line options: Configuration/GenProduction/python/PsiToMuMuwithDzero_13TeV_cfi.py --fileout file:PsiToMuMuwithDZero_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename PsiToMuMuwithDZero_13TeV_GS.py --no_exec -n 300000
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/PsiToMuMuwithDzero_13TeV_cfi.py nevts:300000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PsiToMuMuwithDZero_13TeV_GS.root'),
...
process.psifilter = cms.EDFilter("PythiaDauFilter",
...
process.mumufilter = cms.EDFilter("MCParticlePairFilter",
    ...
    minInvMass = cms.untracked.double(3.6)
)


process.ProductionFilterSequence = cms.Sequence(process.generator+process.psifilter+process.dzerofilter+process.mumufilter)
