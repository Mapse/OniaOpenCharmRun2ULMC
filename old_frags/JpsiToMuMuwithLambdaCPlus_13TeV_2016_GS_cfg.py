...
# with command line options: Configuration/GenProduction/python/JpsiToMuMuwithLambdaCPlus_13TeV_cfi.py --fileout file:JpsiToMuMuwithLambdaCPlus_13TeV_2016_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mcRun2_asymptotic_preVFP_v8 --beamspot Realistic25ns13TeV2016Collision --step GEN,SIM --geometry DB:Extended --era Run2_2016_HIPM --python_filename JpsiToMuMuwithLambdaCPlus_13TeV_2016_GS_cfg.py -n 10000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/JpsiToMuMuwithLambdaCPlus_13TeV_cfi.py nevts:10000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:JpsiToMuMuwithLambdaCPlus_13TeV_2016_GS.root'),
...
process.lambdaCPlusfilter = cms.EDFilter("MCSingleParticleFilter",
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.jpsifilter+process.lambdaCPlusfilter+process.mumufilter)
