...
nevt=1
# GS cfg fragment 
py_gs=Jpsi_Dstar_DPS_2016preVFP_13TeV_GS_cfg.py
# For MC Gen parameters 
REPORT_NAME=Jpsi_Dstar_DPS_2016preVFP_13TeV_GS_report.xml
# DR cfg fragment
py_dr=Jpsi_Dstar_DPS_2016preVFP_13TeV_DR_cfg.py
# HLT cfg fragment
py_hlt=Jpsi_Dstar_DPS_2016preVFP_13TeV_HLT_cfg.py
# AOD cfg fragment
py_aod=Jpsi_Dstar_DPS_2016preVFP_13TeV_AOD_cfg.py

## Root files

# GS root
root_gs=Jpsi_Dstar_DPS_2016preVFP_13TeV_GS.root
# DR root
root_dr=Jpsi_Dstar_DPS_2016preVFP_13TeV_DR.root
# HLT root
root_hlt=Jpsi_Dstar_DPS_2016preVFP_13TeV_HLT.root
# AOD root
root_aod=Jpsi_Dstar_DPS_2016preVFP_13TeV_AOD.root

# CmsDriver for GS step
cmsDriver.py $path_gs --fileout file:$root_gs --mc --eventcontent RAWSIM --runUnscheduled --datatier GEN-SIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --beamspot Realistic25ns13TeV2016Collision --step GEN,SIM --customise Configuration/DataProcessing/Utils.addMonitoring --nThreads 1 --geometry DB:Extended --era Run2_2016_HIPM --python_filename $py_gs -n $nevt --no_exec
...
cmsDriver.py --filein file:$root_hlt --fileout file:$root_aod --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 106X_mcRun2_asymptotic_preVFP_v9 --step RAW2DIGI,L1Reco,RECO,RECOSIM --nThreads 1 --geometry DB:Extended --era Run2_2016_HIPM --python_filename $py_aod -n 1 --no_exec
