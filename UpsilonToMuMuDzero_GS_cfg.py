...
# with command line options: Configuration/GenProduction/python/UpsilonToMuMuDzero_7TeV_cfi.py --fileout file:UpsilonToMuMuDzero_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v7 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --geometry DB:Extended --era Run2_2017 --python_filename UpsilonToMuMuDzero_GS_cfg.py -n 500000 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/UpsilonToMuMuDzero_7TeV_cfi.py nevts:500000'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:UpsilonToMuMuDzero_GS.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.upsilonfilter+process.dzerofilter+process.upsilondaufilter+process.dzerodaufilter)
