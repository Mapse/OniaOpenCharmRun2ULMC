...
# with command line options: Configuration/GenProduction/python/Jpsi_Dstar_new_accept_cuts_13TeV_cfi.py --fileout file:Jpsi_Dstar_new_accept_cuts_13TeV_GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 106X_mc2017_realistic_v8 --beamspot Realistic25ns13TeVEarly2017Collision --step GEN,SIM --customise Configuration/DataProcessing/Utils.addMonitoring --geometry DB:Extended --era Run2_2017 --python_filename Jpsi_Dstar_new_accept_cuts_13TeV_GS_cfg.py -n 1 --no_exec
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/Jpsi_Dstar_new_accept_cuts_13TeV_cfi.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:Jpsi_Dstar_new_accept_cuts_13TeV_GS.root'),
...
process.ProductionFilterSequence = cms.Sequence(process.generator+process.jpsifilter+process.mumufilter+process.DstarFilter)
